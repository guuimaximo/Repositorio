...
export default function SolicitacaoTratativa() {
  ...
  async function salvar() {
    ...
    try {
      // ✅ Auditoria do criador (fallback em usuarios_aprovadores)
      ...
      const payload = {
        ...
        linha: form.linha || null, // ✅ pode ser "NA"
        descricao: form.descricao,
        status: "Pendente",

        // Legado: primeira evidência
        imagem_url: evidenciasUrls[0] || null,

        // Novo: todas as evidências
            ...
            <div className="w-full">
              <div className="rounded-xl border bg-white p-4 h-full">
                ...
                >
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    A imagem será adicionada automaticamente nas evidências.
                  </p>
                </div>
